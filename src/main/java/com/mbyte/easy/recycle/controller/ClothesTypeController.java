...
public class ClothesTypeController extends BaseController  {
    ...
    */
    @PostMapping("add")
    @ResponseBody
    public AjaxResult add(ClothesType clothesType,@PathParam("file") MultipartFile file){
    ...
    */
    @PostMapping("edit")
    @ResponseBody
    public AjaxResult edit(String type,Long id,@PathParam("file") MultipartFile file){
        ClothesType clothesType = new ClothesType();
        clothesType.setType(type);
        clothesType.setId(id);
        if(file != null) {
